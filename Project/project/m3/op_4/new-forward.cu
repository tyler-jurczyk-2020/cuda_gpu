...
// OP_4 --> Weight Matrix (Kernel) in constant memory

__constant__ float constant_mask [7500];

__global__ void conv_forward_kernel(float *output, const float *input, const int Batch, const int Map_out, const int Channel, const int Height, const int Width, const int K, const int out_grid_width)
{
    /*
...
__host__ void GPUInterface::conv_forward_gpu(float *device_output, const float *device_input, const float *device_mask, const int Batch, const int Map_out, const int Channel, const int Height, const int Width, const int K)
{
    ...
    conv_forward_kernel<<<grid_dim, block_dim>>>(device_output, device_input, Batch, Map_out, Channel, Height, Width, K, output_width_tiles);
